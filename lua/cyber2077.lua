...
local set_groups = function()
  ...
  local code_syntax = {
      Comment        = { fg = fg_dark, gui = 'italic' }, -- done
      Constant       = { fg = cyan },
      String         = { fg = green }, -- done
  ...
  local lang_syntax = {
      ...
      rustKeyword     = { fg = red },
      rustFuncCall    = { fg = cyan },
      rustModPathSep  = { fg = fg_light },
      rustIdentifier  = { fg = red },
      rustFuncName    = { fg = cyan },
      rustSigil       = { fg = cyan },
      rustMacro       = { fg = blue },
      rustStorage     = { fg = cyan },
      rustModPath     = { fg = fg_light },
      rustEnumVariant = { fg = purple },
      rustStructure   = { fg = cyan },
      rustTypedef     = { fg = orange },
      rustIdentifierPrime = { fg = purple },
